defmodule ForceClosePortAfterTest do
    ...
    test "Test force_close_port_after" do
      ...
      ## run command
      cmd_output = MuonTrap.cmd("bash", ["test/force_close_port_after_test.sh", @temp_output_file, @temp_output_text], force_close_port_after: :timer.seconds(@force_close_port_after_seconds))
      ...
      assert @expected_output_count == File.read!(@temp_output_file) |> String.split |> Enum.count(fn x -> x == @temp_output_text end)
